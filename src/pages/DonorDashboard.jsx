...
const DonorDashboard = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!pickupCoords) { alert('Please pin the exact pickup location on the map.'); return; }
    addDonation({
      ...formData,
      donor_id: user.id,
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="form-group" style={{ marginBottom: '1.5rem' }}>
                    ...
                    <input type="text" className="form-control" required
                      ...
                      placeholder="Street address / Landmark near pickup"
                      style={{ marginBottom: '0.75rem' }}
                    />
                    <label className="form-label">Pin Exact Pickup Location on Map <span style={{ color: 'var(--danger)', fontSize: '0.8rem' }}>* Required</span></label>
                    <LocationPicker height="300px" onChange={(latlng) => setPickupCoords(latlng)} />
                  </div>

...
const SignupPage = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    upi_id: '', payment_qr: null, coords: null,
  });
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.role === 'center' && !formData.coords) { setError('Please pin your location on the map'); return; }
    setLoading(true);
          ...
          <div className="auth-left-content">
            ...
            <div className="auth-features">
              <div className="auth-feature">
                ...
                <div><strong>850+ Volunteers</strong><span>Growing community</span></div>
              </div>
              <div className="auth-feature">
                <div className="auth-feature-icon">🏠</div>
                <div><strong>120+ Centers</strong><span>Partner institutions</span></div>
              </div>
              <div className="auth-feature">
                <div className="auth-feature-icon">💰</div>
                <div><strong>₹18 Lakh+</strong><span>Funds raised</span></div>
              </div>
            </div>
          </div>
        </div>
              ...
              {formData.role === 'center' && (
                <>
                  ...
                  <div className="form-group" style={{ marginBottom: '1.5rem' }}>
                    <label className="form-label">Pin Location on Map <span style={{ color: 'var(--danger)', fontSize: '0.8rem' }}>* Required</span></label>
                    <LocationPicker height="260px" onChange={(latlng) => setFormData({ ...formData, coords: latlng })} />
                  </div>
                </>
              )}
